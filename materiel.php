...
$requete="INSERT INTO reserver (id_materiel, date_debut, date_retour, quantite_reserver) VALUES ('".$_POST["id_materiel"]."', '".$_POST["date_debut"]."', '".$_POST["date_retour"]."', '".$_POST["quantite_reserver"]."')";
